...
public class TestRunner implements CommandLineRunner {
    ...
    private void initializeDb() {
        int numOfObject1 = 15000;
        int numOfObject2 = 15000;
        ...
        jdbcTemplate.update("DELETE FROM object_2");
        jdbcTemplate.update("DELETE FROM object_1");

        jdbcTemplate.batchUpdate("""
                        INSERT INTO object_1 (id, name)
                        VALUES (?, ?)""",
        ...
        jdbcTemplate.batchUpdate("""
                        INSERT INTO object_2 (id, name, object_1_id)
                        VALUES (?, ?, ?)""",
